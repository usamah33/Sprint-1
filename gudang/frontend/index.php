      ...
      <article class="col1">
        <div class="box1">
          ...
          <div class="pad"> <strong>From Birmingham</strong><br>
            ...
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 176.-</span> <a href="book2.php">Basel</a> </li>
              <li> <span class="right color1">from GBP 109.-</span> <a href="book2.php">Geneva</a> </li>
            </ul>
          ...
          <div class="pad"> <strong>From Dublin</strong><br>
            <ul class="pad_bot2 list1">
              <li class="pad_bot1"> <span class="right color1">from EUR 122.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
          </div>
        </div>
      </article>
      <article class="col2">
        ...
        <div class="wrapper">
          <article class="cols">
            ...
            <p>This website template is optimized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid. This website template has several pages: <a href="index.php">About</a>, <a href="offers.php">Offers</a>, <a href="book.php">Book</a>, <a href="services.php">Services</a>, <a href="safety.php">Safety</a>, <a href="contacts.php">Contacts</a>.</p>
          </article>
