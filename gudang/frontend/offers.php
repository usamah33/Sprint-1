  ...
  <header>
    ...
    <nav>
      <ul id="menu">
        ...
        <li id="menu_active"><a href="offers.php"><span><span>Offers</span></span></a></li>
        ...
        <div class="box1">
          ...
          <div class="pad"> <strong>Birmingham</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 143.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
            <strong>London (LCY)</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 176.-</span> <a href="book2.php">Geneva</a> </li>
              <li> <span class="right color1">from GBP 109.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
            <strong>London (LHR)</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 100.-</span> <a href="book2.php">Geneva</a> </li>
              <li> <span class="right color1">from GBP 112.-</span> <a href="book2.php">Zurich</a> </li>
              <li> <span class="right color1">from GBP 88.-</span> <a href="book2.php">Basel</a> </li>
            </ul>
            <strong>Manchester</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 97.-</span> <a href="book2.php">Basel</a> </li>
              <li> <span class="right color1">from GBP 103.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
            <strong>Edinburgh</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 165.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
          </div>
        </div>
      </article>
      <article class="col2">
        ...
        <div class="wrapper pad_bot3">
          ...
          <div class="cols">
            <h4>From UK</h4>
            <ul class="list1">
              <li> <span class="color1 right">from GBP 130.-</span> <a href="book2.php">Malaga</a> </li>
              <li> <span class="color1 right">GBP 144.-</span> <a href="book2.php">Rome</a> </li>
              <li> <span class="color1 right">from GBP 146.-</span> <a href="book2.php">Budapest</a> </li>
              <li> <span class="color1 right">from GBP 146.-</span> <a href="book2.php">Bucharest</a> </li>
              <li> <span class="color1 right">from GBP 159.-</span> <a href="book2.php">Athens</a> </li>
        ...
        <div class="wrapper pad_bot3">
          ...
          <div class="cols">
            ...
            <ul class="list1 pad_bot1">
              <li> <span class="color1 right">from GBP 143.-</span> <a href="book2.php">Zurich</a> </li>
            </ul>
            <h4>From London Heatrow</h4>
            <ul class="list1 pad_bot1">
              <li> <span class="color1 right">from GBP 146.-</span> <a href="book2.php">Zurich</a> </li>
              <li> <span class="color1 right">from GBP 146.-</span> <a href="book2.php">Geneva</a> </li>
              <li> <span class="color1 right">from GBP 159.-</span> <a href="book2.php">Basel</a> </li>
            </ul>
        ...
        <div class="wrapper">
          ...
          <div class="cols">
            <h4>From UK</h4>
            <ul class="list1 pad_bot1">
              <li> <span class="color1 right">from GBP 464.-</span> <a href="book2.php">Hong Kong</a> </li>
              <li> <span class="color1 right">from GBP 509.-</span> <a href="book2.php">Johannesburg</a> </li>
              <li> <span class="color1 right">from GBP 601.-</span> <a href="book2.php">Bangkok</a> </li>
              <li> <span class="color1 right">from GBP 727.-</span> <a href="book2.php">Paulo</a> </li>
              <li> <span class="color1 right">from GBP 464.-</span> <a href="book2.php">Zurich</a> </li>
              <li> <span class="color1 right">from GBP 509.-</span> <a href="book2.php">Geneva</a> </li>
              <li> <span class="color1 right">from GBP 601.-</span> <a href="book2.php">Basel</a> </li>
