  ...
  <!-- [JS External] -->
  <!-- jQuery -->
  <script type="text/javascript" src="<?php echo base_url();?>sauce/jquery/jquery-3.3.1.min.js"></script>
  <!-- Popper -->
  ...
  <script type="text/javascript">
    ...
    if ((getdate.getMonth() + 1) < 9) month = "0" + (getdate.getMonth() + 1);
    else month = (getdate.getMonth() + 1);
    date = getdate.getDate();
    var x = document.getElementsByClassName("form-control width-index date-now");
    x[0].value = year + "/" + month + "/" + date;
  </script>
</body>
</html>