  ...
  <div class="container bg-light">
    ...
    <form action="">
        ...
        <div class="col-7">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                <label>Phone:</label>
                <input type="text" name="phone" class="form-control" placeholder="use international format, ex: +628...">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
      ...
      <button class="btn btn-primary float-right"><b>Next</b> <i class="fas fa-angle-right"></i></button>
    </form>
    <button class="btn btn-secondary float-left" onclick="window.history.back()"><i class="fas fa-angle-left"></i> <b>Back</b></button>
  </div>