...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="<?php echo base_url(); ?>gudang/admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="<?php echo base_url(); ?>gudang/admin/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->

  <!-- Google Font -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>gudang/admin/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url('index.php/insert/departlist'); ?>" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('index.php/admin'); ?>"><i class="fa fa-circle-o"></i> Make New Departure Schedule</a></li>
            <li class="active"><a href="<?php echo base_url('index.php/insert/departlist'); ?>"><i class="fa fa-circle-o"></i> Departure Schedule List</a></li>
          </ul>
    ...
    <section class="content">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Departure List</h3>
            </div>
              <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="<?php echo base_url(); ?>gudang/admin/https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="#<?php echo base_url(); ?>gudang/admin/control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="#<?php echo base_url(); ?>gudang/admin/control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="<?php echo base_url(); ?>gudang/admin/javascript:void(0)">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="<?php echo base_url(); ?>gudang/admin/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
